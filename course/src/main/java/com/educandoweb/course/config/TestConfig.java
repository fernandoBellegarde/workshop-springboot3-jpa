...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Order o4 = new Order(null, Instant.parse("2019-07-23T10:10:33Z"), OrderStatus.CANCELED, u3);
        Order o5 = new Order(null, Instant.parse("2006-10-02T23:06:06Z"), OrderStatus.DELIVERED, u3);
        Order o6 = new Order(null, Instant.parse("2019-07-24T10:10:33Z"), OrderStatus.SHIPPED, u4);
